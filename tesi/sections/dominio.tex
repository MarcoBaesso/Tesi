...
A inizio stage la scelta della tecnologia \`{e} stata convenuta dall\textquoteright{}azienda. La soluzione consisteva nella modifica di un software opensource la cui funzionalit\`{a} era proprio quella di realizzare la pianificazione dei progetti utilizzando come strumento tecnico di pianificazione il diagramma di \textit{\textbf{Gantt}}. Il software opensource pu\`{o} essere scaricato dalla piattaforma di \textit{\textbf{SourceForge}} al seguente indirizzo: \url{http://sourceforge.net/projects/opproject/}.
